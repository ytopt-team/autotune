...
project = u'Autotune'
copyright = u'2019, Argonne'
author = u'Argonne'

# The short X.Y version
about = {}
with open(f'../autotune/__version__.py') as f:
    exec(f.read(), about)
...
latex_documents = [
    (master_doc, 'autotune.tex', u'autotune Documentation',
     u'ArgonneMCS', 'manual'),
]
...
man_pages = [
    (master_doc, 'autotune', u'autotune Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'autotune', u'autotune Documentation',
     author, 'autotune', 'One line description of project.',
     'Miscellaneous'),
]
